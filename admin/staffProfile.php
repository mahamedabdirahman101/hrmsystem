                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile text-center">
                            <img class="profile-user-img img-fluid img-circle" src="uploads/staff/<?= $staff_info['photo'] ?: 'default.png'; ?>" alt="Profile picture">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($staff_info['documents'])): ?>
                                <hr>
                                <a href="uploads/docs/<?= htmlspecialchars($staff_info['documents']); ?>" target="_blank" class="btn btn-success btn-block">
...
$monthStart = $selected_month . '-01';  // First day of the month

$present = 0;
$totalDays = 0;
$percentage = 0;

$query = "SELECT present_days, total_days, percentage 
...
if (!$result) {
    die("Error in attendance summary query: " . mysqli_error($con));
}
    ...
    $percentage = round((float)$row['percentage'], 2);
                    ...
                    <div class="card card-primary mb-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <form method="GET" class="d-flex">
                                <input type="hidden" name="staff_id" value="<?= $staff_id ?>">
                                    <input type="month" name="month" value="<?= $selected_month ?>" class="form-control mr-2" onchange="this.form.submit()">
                                </form>
                        </div>
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted">of days present (<?= $present ?>/<?= $totalDays ?>) for <?= date('F Y', strtotime($selected_month)) ?></p>
                        </div>
                    </div>
                </div>
            </div>
