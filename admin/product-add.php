                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                                ...
                                                <select name="category_id" class="form-control"  id="nameSelect">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="small_description" class="form-control" required rows="3" placeholder="Enter Small Description"></textarea>
                                    </div>
                                </div>
